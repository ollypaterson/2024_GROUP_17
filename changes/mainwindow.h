...
#include <QMainWindow>
#include "VRRenderThread.h" // 🔄 Include VRRenderThread header
...
private:
    ...
    vtkSmartPointer<vtkGenericOpenGLRenderWindow>  vrRenderWindow; // Add
    vtkSmartPointer<vtkRenderer> vrRenderer; // Add
    vtkSmartPointer<vtkRenderer> renderer;
    VRRenderThread *vrThread; // Declare the VRRenderThread
};
